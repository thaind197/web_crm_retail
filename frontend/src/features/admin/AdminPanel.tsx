...
export const AdminPanel: React.FC = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      // Fallback mock users
      setUsers([
        { id: 'u1', userName: 'admin', fullName: 'Quản trị viên (Admin)', email: 'admin@salescrm.com', roles: ['Admin'], isActive: true },
        { id: 'u2', userName: 'staff_hn', fullName: 'Nhân viên Hà Nội', email: 'hn@salescrm.com', roles: ['Staff'], branchName: 'Chi nhánh Hà Nội', isActive: true }
      ]);
    } finally {
  ...
  const fetchBranches = async () => {
    ...
    try {
      ...
      setBranches([
        { id: 'b1', name: 'Chi nhánh Hà Nội', address: '12 Cầu Giấy, HN', phone: '0243123456', isActive: true },
        { id: 'b2', name: 'Chi nhánh Hồ Chí Minh', address: '45 Quận 1, HCM', phone: '0283123456', isActive: true }
      ]);
    } finally {
